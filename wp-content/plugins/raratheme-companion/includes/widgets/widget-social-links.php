                    ...
                    { 
                        ...
                        { 
                            ...
                            <li class="rtc-social-icon-wrap">
                                <a title="<?php echo esc_attr($icon);?>" <?php if(isset($instance['target']) && $instance['target']=='1'){ echo "target=_blank"; } ?> href="<?php echo esc_url($instance['social'][$value]);?>"><span class="rtc-social-links-field-handle fa fa-<?php echo esc_attr($icon);?>" style="font-family: 'FontAwesome';"></span></a>
                            </li>
                        <?php
                            }
                        }
